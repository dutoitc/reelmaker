...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--subtitle-font-size", type=int, default=64, help="Burned subtitle font size for 1080x1920 ASS subtitles.")
    parser.add_argument("--subtitle-margin-v", type=int, default=220, help="Vertical bottom margin for subtitles. Larger = higher above bottom.")
    parser.add_argument("--crop-mode", choices=["center", "face"], default="center", help="Vertical crop mode. 'face' uses optional OpenCV frontal-face detection, then falls back to center.")
    ...
    parser.add_argument("--youtube-cta", default="Video complete sur YouTube", help="Text shown on the final YouTube card.")
